      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className={`mt-1 ${isDark ? 'text-gray-400' : 'text-gray-600'}`}>Communicate with patients and experts</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className={`rounded-lg shadow p-6 ${isDark ? 'bg-gray-800' : 'bg-white'}`}>
            <div className="flex items-center justify-between">
              <div>
                <p className={`text-sm ${isDark ? 'text-gray-400' : 'text-gray-600'}`}>Total Conversations</p>
          ...
          <div className={`rounded-lg shadow p-6 ${isDark ? 'bg-gray-800' : 'bg-white'}`}>
            <div className="flex items-center justify-between">
              <div>
                <p className={`text-sm ${isDark ? 'text-gray-400' : 'text-gray-600'}`}>Unread Messages</p>
        ...
        <div className={`rounded-lg shadow overflow-hidden ${isDark ? 'bg-gray-800' : 'bg-white'}`}>
          <div className="grid grid-cols-12 h-[600px]">
            {/* Conversations List */}
            <div className={`${selectedConversation ? 'hidden md:flex md:col-span-4' : 'col-span-12 md:col-span-4 flex'} flex-col border-r h-full ${isDark ? 'border-gray-700' : 'border-gray-200'}`}>
              <div className={`flex-shrink-0 p-4 border-b ${isDark ? 'border-gray-700 bg-gray-700' : 'border-gray-200 bg-gray-50'}`}>
                <input
                  type="text"
                  placeholder="Search conversations..."
                  className={`w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-600 focus:border-transparent ${
                    isDark ? 'bg-gray-600 border-gray-600 text-white placeholder-gray-400' : 'border-gray-300'
                  }`}
                />
              </div>
            ...
            <div className={`${selectedConversation ? 'col-span-12 md:col-span-8' : 'col-span-8'} flex flex-col h-full overflow-hidden`}>
              {selectedConversation ? (
                <div className="flex flex-col h-full">
                  ...
                  <div className={`flex-shrink-0 p-4 border-b flex items-center justify-between ${
                    ...
                    <div className="flex items-center gap-3">
                      <button
                        ...
                        className={`p-2 rounded-lg transition-colors border shadow-sm md:hidden ${
                          isDark ? 'bg-gray-800 border-gray-600 hover:bg-gray-600' : 'bg-white border-gray-300 hover:bg-gray-200'
                        }`}
                      >
                  ...
                  {/* Messages */}
                  <div className={`flex-1 overflow-y-auto p-4 space-y-4 min-h-0 ${isDark ? 'bg-gray-900' : 'bg-gray-50'}`}>
                    {messages.length === 0 && (
                            ...
                            <div className="flex items-end gap-2">
                              ...
                              >
                                ...
                                <p className={`text-xs mt-1 ${
                                  isCurrentUser ? 'text-blue-100' : isDark ? 'text-gray-500' : 'text-gray-500'
                                }`}>
